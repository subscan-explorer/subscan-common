...
// go test -v -test.run TestHasLocalIPddr
...
// go test -v -test.run TestHasLocalIPAddr
...
// go test -v -test.run TestHasLocalIP
...
// go test -v -test.run TestRemoteIP
...
// go test -v -test.run TestClientIP
...
// go test -v -test.run TestClientPublicIP
...
// go test -v -test.run TestIPString2Long
...
// go test -v -test.run TestLong2IPString
...
// go test -v -test.run TestIP2Long
...
// go test -v -test.run TestLong2IP
